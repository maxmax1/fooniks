...
function aAdminMenu ()
	if ( aAdminForm == nil ) then
		...
		aTab1.SetDimension	= guiCreateButton ( 0.71, 0.755, 0.083, 0.04, "Dim", true, aTab1.Tab, "setdimension" )
		aTab1.SetInterior		= guiCreateButton ( 0.803, 0.755, 0.083, 0.04, "Int", true, aTab1.Tab, "setinterior" )
		aTab1.SetRInterior		= guiCreateButton ( 0.896, 0.755, 0.083, 0.04, "rInt", true, aTab1.Tab, "setrinterior" )
		...
		aTab1.WarpTo		= guiCreateButton ( 0.71, 0.665, 0.13, 0.04, "Warp to..", true, aTab1.Tab, "warp" )
		aTab1.TeleTo		= guiCreateButton ( 0.85, 0.665, 0.13, 0.04, "Teleport to..", true, aTab1.Tab, "tele" )
		...
		if ( getElementParent ( source ) == aTab1.Tab ) then
			...
			elseif ( getElementType ( source ) == "gui-button" )  then
				...
				if ( guiGridListGetSelectedItem ( aTab1.PlayerList ) == -1 ) then
					...
					elseif ( source == aTab1.SetRInterior ) then aInputBox ( "Interior ID Required", "Enter Interior ID between 0  and 255", "0", "triggerServerEvent ( \"aPlayer\", getLocalPlayer(), getPlayerFromNick ( \""..escname.."\" ), \"setrinterior\", $value )" )
					...
					elseif ( source == aTab1.TeleTo ) then aPlayerTele ( player )
